...
export interface ApiThemeSettingThemeSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    IsAutumn: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    IsSpring: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    IsSummer: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
